        ...
        while True:
            ...
            if ex_habit in habit_options:
                ...
                if answer:
                    ...
                    habit_index = (
                        self.habit_tracker.habit_options.index(ex_habit) + 1
                    )
...
def delete_account(self):
    username_column = self.habit_tracker.credentials_worksheet.col_values(1)
    ...
    user_index = username_column.index(self.habit_tracker.logged_in_user) + 1
